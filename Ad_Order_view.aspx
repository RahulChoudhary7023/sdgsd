<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ad_Order_view.aspx.cs" Inherits="Ad_Order_view" %>
                                        ...
                                        <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%# Eval("StreetAdd1") %></td>
                                                    <td><%# Eval("number") %></td>
                                                    <td><%# Eval("Amount", "{0:C}") %></td>
                                                    <td><%# Eval("OrderStatus") %></td>
                                                    <td>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" Text="Change" CommandName="change_status"></asp:LinkButton>
                                                    </td>
                                                    <td>

                                                        <asp:LinkButton ID="LinkButton_View" runat="server" Text="View" CommandName="btn_Details"
                                                            CssClass="btn btn-primary btn-sm"></asp:LinkButton>
                                                        <asp:LinkButton ID="LinkButton_Delete" runat="server" Text="Remove" CommandName="btn_Delete"
