<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Cart_Chackout.aspx.cs"
    Inherits="Cart_Chackout" %>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-5">
                            <div class="table-responsive">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" class="py-5">
                                                        <div class="form-check">
                                                            <asp:CheckBox ID="chkFreeShipping" runat="server" AutoPostBack="True" OnCheckedChanged="ShippingOption_CheckedChanged" />
                                                            <asp:Label ID="lblFreeShipping" runat="server" AssociatedControlID="chkFreeShipping"
                                                                Text="Free Shipping" Style="color: #81c408;" />
                                                        </div>
                                                        <div class="form-check mt-2">
                                                            <asp:CheckBox ID="chkLocalPickup" runat="server" AutoPostBack="True" OnCheckedChanged="ShippingOption_CheckedChanged" />
                                                            <asp:Label ID="Label1" runat="server" AssociatedControlID="chkLocalPickup" Text="Local Pickup: 20"
                                                                Style="color: #81c408;" />
                                                        </div>
                                                        <div class="form-check mt-2">
                                                            <asp:CheckBox ID="chkFlatRate" runat="server" AutoPostBack="True" OnCheckedChanged="ShippingOption_CheckedChanged" />
                                                            <asp:Label ID="Label2" runat="server" AssociatedControlID="chkFlatRate" Text="Flat rate: 45"
                                                                Style="color: #81c408;" />
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr style="width: 100% !important;">
                                                    <td colspan="5" class="py-5 text-end">
                                                        <div class="py-3">
                                                            <asp:LinkButton ID="LinkButton1" CausesValidation="true" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4"
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="chkFreeShipping" EventName="CheckedChanged" />
                                        <asp:AsyncPostBackTrigger ControlID="chkLocalPickup" EventName="CheckedChanged" />
                                        <asp:AsyncPostBackTrigger ControlID="chkFlatRate" EventName="CheckedChanged" />
