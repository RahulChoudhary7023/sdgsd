                ...
                <nav class="navbar navbar-light navbar-expand-xl" id="navcol">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <asp:HyperLink ID="HyperLink3" class="nav-item nav-link" NavigateUrl="~/Shop.aspx"
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                        <asp:HyperLink ID="HyperLink5" NavigateUrl="~/Cart.aspx" class="dropdown-item" runat="server">Cart</asp:HyperLink>
                                    <asp:HyperLink ID="HyperLink8" NavigateUrl="~/Order.aspx" class="dropdown-item" runat="server">Order</asp:HyperLink>
                                    <asp:HyperLink ID="HyperLink11" NavigateUrl="~/About.aspx" class="dropdown-item" runat="server">About</asp:HyperLink>
                                </div>
                                </div>
                            </div>
                            <asp:HyperLink ID="HyperLink6" NavigateUrl="~/Contact.aspx" class="nav-item nav-link"
                        ...
                        <div class="d-flex m-3 me-0 pe-5 align-items-center">
                            ...
                            <asp:HyperLink ID="HyperLink7" class="position-relative me-4 my-auto" NavigateUrl="~/Sign_in.aspx"
                                runat="server">
                    <i class="fa fa-power-off custom-icon-size" aria-hidden="true"></i>
                            </asp:HyperLink>
                            <asp:ImageButton ID="IMg_Av" Visible="false" PostBackUrl="~/USprofile.aspx" CssClass="rounded-circle" src="img/avatar.jpg"
                                Width="40" Height="35" runat="server" />
                            <asp:Repeater ID="Repeater3" runat="server">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton1" CausesValidation="false" CssClass="rounded-circle" PostBackUrl="~/USprofile.aspx" runat="server"
        ...
        <div class="container-fluid py-5">
            <div class="container py-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <img src="img/shopping.png" width="150" class="bi bi-exclamation-triangle display-1 text-secondary" />
                        <h1 class="display-1">Thank you!</h1>
                        <p class="mb-4">Thank you for your purchase. We are honored to have customers like you.
                            Thank you for supporting our small business. It's thanks to customers like you that
                            we can keep crafting our quality [product]. </p>
                        <asp:HyperLink ID="HyperLink1" NavigateUrl="~/Home.aspx" class="btn border-secondary rounded-pill py-3 px-5"
                            runat="server">Go Back To Home</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <asp:HyperLink ID="HyperLink12" NavigateUrl="~/USprofile.aspx" CssClass="btn-link"
                                runat="server">My Account</asp:HyperLink>
                            <asp:HyperLink ID="HyperLink13" NavigateUrl="~/shop.aspx" CssClass="btn-link" runat="server">Shopping</asp:HyperLink>
                            <asp:HyperLink ID="HyperLink14" NavigateUrl="~/Cart.aspx" CssClass="btn-link" runat="server">Shopping Cart</asp:HyperLink>
                            <asp:HyperLink ID="HyperLink15" NavigateUrl="~/Order.aspx" CssClass="btn-link" runat="server">Order History</asp:HyperLink>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
