<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Ad_Product_add.aspx.cs"
    Inherits="Ad_Product_add" %>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txt_MRP" TextMode="Number" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txt_disc" TextMode="Number" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <div class="col-sm-10">
                                            <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary" OnClick="add_Click">Save Change</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
