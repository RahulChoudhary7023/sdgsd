<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ad_Product_view.aspx.cs"
    Inherits="Ad_Product_view" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table class="table table-dark mt-1">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="auto-style1">Photo</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <th scope="row" class="auto-style1">
                                                                <asp:Image ID="Image3" runat="server" Height="52px" Width="70" ImageUrl='<%# Eval("photo") %>' />
                                                            </th>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="LinkButton1" CommandName="add_det" runat="server">Add</asp:LinkButton>
                                                            </td>
                                                            <td>
