<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Ad_Category_add.aspx.cs" Inherits="Ad_Category_add" %>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary" OnClick="add_Click">Save Change</asp:LinkButton>
                  </div>
                </div>
