                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <asp:Image ID="Image1" runat="server" class="img-fluid me-5 rounded-circle" Width="80"
                                                            Height="80" ImageUrl='<%# Eval("photo") %>' />
                                                    </div>
                                                </th>
                                                <td>
                                                    <p class="mb-0 mt-4">
                                                        <asp:Label ID="lbl_cid" runat="server" Visible="false" Text='<%# Eval("Cid") %>'></asp:Label>
                                                ...
                                                <td>
                                                    <div class="input-group quantity mt-4" style="width: 100px;">
                                                        <div class="input-group-btn">
                                                            <asp:LinkButton ID="LinkButton3" runat="server" class="btn btn-sm btn-plus rounded-circle bg-light border"
                                                                CommandName="Decrease" CommandArgument='<%# Eval("Cid") %>'>
                                            <i class="fa fa-minus"></i>
                                        </asp:LinkButton>
                                                        </div>
                                                        <asp:TextBox ID="qtyTextBox" runat="server" CssClass="form-control form-control-sm text-center border-0"
                                                            Text='<%# Eval("Qty") %>' />
                                                        <div class="input-group-btn">
                                                            <asp:LinkButton ID="LinkButton2" runat="server" class="btn btn-sm btn-plus rounded-circle bg-light border"
                                                                CommandName="Increase" CommandArgument='<%# Eval("Cid") %>'>
                                            <i class="fa fa-plus"></i>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="LinkButton1" CommandName="Delete" class="btn btn-md rounded-circle bg-light border mt-4"
                                                        runat="server" CommandArgument='<%# Eval("Cid") %>'>
                ...
                <div class="row g-4 justify-content-end">
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <asp:Button ID="Button1" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4"
                                runat="server" Text="Proceed Checkout" OnClick="Button1_Click" />
                        </div>
                    </div>
                </div>
            </div>
