<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Ad_PrDetails_add.aspx.cs" Inherits="Ad_PrDetails_add" %>
              ...
              <div>
               <asp:Label ID="lbl_Msg" runat="server"></asp:Label>
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  <div class="col-sm-12">  
                        <asp:FileUpload ID="FileUpload2" class="form-control" runat="server"></asp:FileUpload>
                   </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-outline-primary" OnClick="add_Click">Save Change</asp:LinkButton>
                  </div>
                </div>
