<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ad_PrDetails_view.aspx.cs"
    Inherits="Ad_PrDetails_view" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table class="table table-dark">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="auto-style1">PDid</th>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <th scope="row" class="auto-style1">
                                                                <asp:Label ID="Label8" runat="server" Text='<%# Eval("PDid") %>'></asp:Label>
                                                            </th>
                                                            <td>
                                                                <asp:Image ID="Image3" runat="server" Height="52px" Width="70" ImageUrl='<%# Eval("picture1") %>' />
                                                            </td>
                                                            <td>
                                                                <asp:Image ID="Image1" runat="server" Height="52px" Width="70" ImageUrl='<%# Eval("picture2") %>' />
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("Weight") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("PRid") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <asp:Label ID="lbl_PDid" Visible="false" runat="server" Text='<%# Eval("PDid") %>'></asp:Label>
                                                        </tr>
