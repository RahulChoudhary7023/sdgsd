...
public partial class Ad_PrDetails_view : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, EventArgs e)
   {
    ...
    private void FillDetails()
    {
        ...
        qry = "SELECT * FROM ProDetails_tb ORDER BY PRid ASC";
        dt = c1.GetDT(qry);
    ...
    protected void DataList1_ItemCommand1(object source, RepeaterCommandEventArgs e)
    {
        ...
        id = ((Label)DataList1.Items[e.Item.ItemIndex].FindControl("lbl_PDid")).Text;

       if (e.CommandName == "btn_Delete")
        {
            qry1 = "Delete from ProDetails_tb where PDid =" + id;
        ...
        {
            Session.Add("proDE", id);
            Response.Redirect("Ad_PrDetails_update.aspx");
        }
      }
        catch (Exception ex)
        {
